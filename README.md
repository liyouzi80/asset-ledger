...
### 首页 Dashboard
- **Hero 资产总览**：总资产/投资资产双视图切换，水位线透视资产分布（流动/投资/长期/负债率）
- **收益率走势**：TWR / 简单加权 / XIRR / 盈亏额 四种指标切换，自定义时间区间
- **总资产曲线**：月度演进折线图，梯度填充
- **每月盈亏柱图**：市场盈亏 vs 净入金，数值标签直接显示，点击钻取明细
- **资产饼图**：按分组聚类，点击查看分组内账户余额
